	...
	namespace Lua
	{
		...
		public:
			...
			*/
			...
			virtual int				PushLuaObject(void*) = 0;
			...
			virtual int				DestroyObject(void*) = 0;
			virtual int				CreateObject(void) = 0;
			virtual int				SetMember(void*, void*, void*) = 0;
			virtual int				GetNewTable(void) = 0;
			virtual int				SetMember(void*, float) = 0;
			virtual int				SetMember(void*, float, void*) = 0;
			virtual int				SetMember(void*, const char*) = 0;
			virtual int				SetMember(void*, const char*, void*) = 0;
			...
			virtual int				SetMemberFast(void*, int, int) = 0;
			virtual int				RunString(const char*, const char*, const char* lua_code, bool sts_1 = 1, bool sts_1_ = 1) = 0; //supposed to set
